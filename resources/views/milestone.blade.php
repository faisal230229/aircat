            ...
            <div class="grid grid-cols-9 mt-16">
                <div class="col-span-4">
                    @foreach($firstHalf as $milestone)
                        <div class="w-full bg-neutral-gray h-56 rounded-lg p-4">
                ...
                <div class="col-span-1">
                    @for($i = 0; $i < $count; $i++)
                        <div class="h-56 relative mx-auto border border-dashed border-neutral-accent w-max">
                ...
                <div class="col-span-4">
                    @foreach($secondHalf as $milestone)
                        ...
                        <div class="w-full bg-neutral-gray h-56 rounded-lg p-4 space-y-4">
                            <h6 class="font-extrabold text-3xl text-black">{{ $milestone->milestone_year }}</h6>
                            <p>{{ $milestone->content }}</p>
                        </div>
                    @endforeach
