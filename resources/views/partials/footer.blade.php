<footer class="bg-secondary" id="footer">
    <div class="container mx-auto relative">
        <div class="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-0 py-16 pb-8">
            <div class="flex items-start justify-start col-span-2 md:col-auto">
                <ul class="space-y-6">
                    <li>
                                <span>
                    ...
                    <li>
                        <div class="flex items-start justify-start gap-4">
                            ...
                            <a href="mailto:{{ $settings['app_email'] }}" class="text-neutral-light">
                                {{ $settings['app_email'] }}
                            </a>
                        </div>
                    </li>
    ...
    <rect width="24" height="24" fill="white"/>
                            ...
                            <a href="tel:{{ $settings['app_phone'] }}" class="text-neutral-light">
                                {{ $settings['app_phone'] }}
                            </a>
                        </div>
                    </li>
    ...
    <rect width="24" height="24" fill="white"/>
            ...
            <div class="flex items-start justify-start md:justify-end">
                <ul class="space-y-6">
                    ...
                    @foreach($pages as $page)
                        <li>
                            <a href="{{ route('custom-page', $page->slug) }}" class="text-neutral-light capitalize">
                                {{ ucwords($page->title) }}
                            </a>
                        </li>
                    @endforeach
        ...
        <div id="btn" class="fixed right-24 z-50">
            <div>
                <a href="{{ route('contact') }}"
                   class="relative bg-primary rounded-full font-semibold text-neutral-light text-2xl p-4">
                    <span
                        class="absolute top-0 left-0 h-full w-full animate-ping rounded-full bg-primary opacity-75 "></span>
                    Get a Quote
                </a>
            </div>
        </div>
    </div>
    <div class="text-center bg-neutral-800 py-8">
        <p class="text-neutral-light">Copyright © 2024 <a href="{{ route('home') }}">{{ $settings['app_name'] }}</a> | Symbols of Reliability. All
            Rights Reserved</p>
    </div>
</footer>
